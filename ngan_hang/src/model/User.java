...
public class User implements Serializable{
    ...
    public static long getAccountID1(long userID) throws ClassNotFoundException, SQLException{
        Connection conn = connection.Connector.getConnection1();
        String sql = "select so_TK from chuTK_TK_1 where so_CMTND = ?";
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setLong(1, userID);
        ResultSet rs = ps.executeQuery();
        if(rs.next())
    ...
    public static boolean checkExist1(long userID) throws ClassNotFoundException, SQLException{
        Connection conn = connection.Connector.getConnection1();
        String sql = "select * from chuTK_TK_1 where so_CMTND = ?";
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setLong(1, userID);
        ResultSet rs = ps.executeQuery();
        return rs.next();
    ...
    public static void setPassword1(long id, String pass) throws ClassNotFoundException, SQLException {
        Connection conn = connection.Connector.getConnection1();
        String sql = "update chu_TK_1 set password = ? where so_CMTND = ?";
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setString(1, pass);
        ps.setLong(2, id);
        ps.executeUpdate();
    ...
    public static boolean checkPassword1(long id, String pass) throws ClassNotFoundException, SQLException {
        Connection conn = connection.Connector.getConnection1();
        String sql = "select * from chu_TK_1 where so_CMTND = ? and password";
        if (pass != null) {
            sql += "=?";
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setLong(1, id);
    ...
    public static boolean checkPassword1(String rootName, String pass) throws ClassNotFoundException, SQLException{
        if(!rootName.equals("root"))
            return false;
        Connection conn = connection.Connector.getConnection1();
        String sql = "select * from root_1 where root = ?";
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setString(1, pass);
        ResultSet rs = ps.executeQuery();
        return rs.next();
    ...
    public static void setPassword1(String rootName, String pass) throws ClassNotFoundException, SQLException{
        if(!rootName.equals("root")){
            return;
        }
        Connection conn = connection.Connector.getConnection1();
        String sql = "update root_1 set root=?";
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setString(1, pass);
        ps.executeUpdate();
    }
